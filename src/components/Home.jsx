...
function Home() {
  ...
  return (
    <div className="max-w-[1080px] m-auto flex justify-between gap-3 items-center max-lg:flex-wrap-reverse max-lg:px-4 max-xl:px-8 pt-14 top-12">
      ...
      <div className="container-left mx-auto">
        <div className='w-[500px] max-lg:w-[450px] max-sm:w-[350px]  relative bg-[#1F2031] rounded-xl p-8'>
          <HeroBgAnimation />
